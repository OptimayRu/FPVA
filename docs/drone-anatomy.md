...
description: "Подробный разбор всех компонентов FPV-дрона: рама, полётный контроллер, ESC, моторы, пропеллеры, видеосистема, антенны, приёмники и система питания."
---
